...
#include <protocol/packets/ServoMotorPacket.h> // class's header file

namespace protocol {
namespace packets {

// class constructor
ServoMotorPacket::ServoMotorPacket(char groupid, char boardid) : protocol::packets::BoardPacket(groupid,boardid)
{
}
