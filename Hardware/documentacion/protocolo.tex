...
\label{dato}
	...
	En el caso que el comando no los requiera, el campo debe ser nulo y el largo ser\'a 0x05.
...
El bit m\'as significativo indica que el paquete es una respuesta, los bits menos significativos, indicaran a qu\'e comando se esta respondiendo.

Todos los comandos generan una respuesta o al menos un ACK con el campo \emph{DATOS} vacio.
...
En caso de error de CRC deber\'ia retransmitir el paquete o tomar aluna otra acci\'on ante otro tipo de error.
