...
#include <packets/DistanceSensorPacket.h> // class's header file

namespace packets {

// class constructor
DistanceSensorPacket::DistanceSensorPacket(char groupid, char boardid) : packets::BoardPacket(groupid, boardid)
{
}
