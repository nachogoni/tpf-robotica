...
\item{Reconocimiento del objeto a recolectar:} El reconocimiento de los objetos
a recolectar lo realizamos utilizando una c\'amara y un algoritmo encargado de
la detecci\'on y predicci\'on de objetos en las im\'agenes obtenidas. En su
trabajo, Nolfi utiliza los sensores de distancia que posee el Khepera para
reconocer si hay un obst\'aculo o un objeto a recolectar. Para \'esto, tom\'o
muestras de los valores de los sensores ante obst\'aculos y ``basuras'' a
diferentes distancias, para luego armar 2 matrices utilizadas para decidir
si lo que se encuentra frente al robot es un obst\'aculo, un objeto a
recolectar o no hay nada.
...
\begin{figure}[htp]
\centerline{\includegraphics[scale=0.8]{comportamientos/figures/errsistUse.eps}}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[scale=0.55]{comportamientos/graphics/BehaviourDistributionPieUse.png}
...
\begin{figure}[htp]
\centering
\includegraphics[width=1.0\textwidth]{comportamientos/graphics/AllUse.png}
...
\begin{figure}[htp]
\centerline{\includegraphics[scale=0.45]{comportamientos/graphics/CollectUse.png}}
...
\begin{figure}[htp]
\begin{center}
\centerline{\includegraphics[scale=0.45]{comportamientos/graphics/areaCoveredVsTimeUse.png}}
