...
primero se muestran las transiciones desde $i$ hacia $j$ y en el segundo,
transiciones de $j$ hacia $i$.
...
\begin{table}[htp]
	\begin{center}
		...
		\hline
			EO & $0.549\%$ & $0.074\%$ & $0.004\%$ & $0\%$ & $0.202\%$ & $0.170\%$ & $0\%$ \\
		\hline
		\end{tabular}
	\end{center}
