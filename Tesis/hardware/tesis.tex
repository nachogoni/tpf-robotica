...
Usamos el timer de $16$bits del microcontrolador configurado con el clock interno de $20$MHz para determinar el tiempo en el cual
...
% 		\centering
% 		\includegraphics[scale=0.45]{srf05_beam.png}
% 		\caption{Haz ultras\'onico del sensor SRF05.}
% 		\label{hF_srf05}
% 	\end{minipage}
% 	\hspace{0.5cm}
...
configurado con el clock interno de $20$MHz
...
Si el tiempo tomado mayor a los $25ms$ indica que no se detect\'o ning\'un objeto dentro del rango de detecci\'on.
