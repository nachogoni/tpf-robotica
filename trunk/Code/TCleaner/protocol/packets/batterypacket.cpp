...
#include <protocol/packets/BatteryPacket.h> // class's header file

namespace protocol {
namespace packets {

// class constructor
BatteryPacket::BatteryPacket(char groupid, char boardid) : protocol::packets::BoardPacket(groupid,boardid)
{
}
