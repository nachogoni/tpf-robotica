...
Por ejemplo, si el valor entro 1023, codificaco en un entero de 16 bits en hexadecimal es 0x03FF,
entonces se env\'ia primero el byte 0xFF y luego el 0x03.
Si fuera el caso del valor entero 1193046, que codificado en un entero de 32 bits, cuyo hexadecimal es 0x00123456,
