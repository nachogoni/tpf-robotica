...
#include "BatteryBoardPacketHandler.h" // class's header file
...
void BatteryBoardPacketHandler::handlePacket(Packet * p){
	BatteryPacket * dcmp = new BatteryPacket(groupid,boardid);
...
double BatteryBoardPacketHandler::getValue(){
 	BatteryPacket * p = new BatteryPacket(groupid,boardid);
	p->senseBattery();
	p->prepareToSend();
