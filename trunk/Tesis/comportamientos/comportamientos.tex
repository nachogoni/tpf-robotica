...
\\\indent Como observamos en el pseudo-c\'odigo del cuadro
\ref{focus_garbage:impl}, el algoritmo enfoca la basura que se encuentra m\'as
...
vertical que forma la c\'amara con el objeto en cuesti\'on. \'Este se computa
...
\\ Para el c\'omputo de la ecuaci\'on \ref{eq:asin}
tambi\'en es necesario el valor de $\alpha$ el cual computamos como
...
\begin{figure}[htp]
\begin{center}
\includegraphics[scale=0.25]{comportamientos/figures/distancias.png}
\caption[Distancias a pixeles en imagen]
		{Distancias a pixeles en imagen seg\'un la variaci\'on de color.
		Los arcos marcan distancias iguales. Cuanto m\'as clara la zona, m\'as
		lejana est\'a. \emph{Dentro} de cada zona delimitada
		por dos arcos hay una variaci\'on de un color m\'as claro a uno oscuro
		a medida que se sube en la im\'agen. Cuanto m\'as claro, m\'as cercano.
		}
