...
Para que pudieramos ver m\'as en detalle lo que suced\'io con los
...
En los cuadros \ref{behaviour_stats1} y \ref{behaviour_stats2} mostramos
...
activo en el timestep $t-1$ ni en el $t$}, respectivamente. Podemos ver que
\emph{Recolectar basura} es en promedio el mayor en ambas tablas y que tiene
el menor desv\'io est\'andar en $caa$. \emph{Wandering} es en promedio el que
menor tiempo est\'a $cai$
