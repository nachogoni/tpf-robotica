...
En este trabajo hemos llevado a cabo el diseño la construcci\'on e implementaci\'on
...
%~ Si ponemos future work descomentemos esto 
%~ \indent Resaltamos algunas \'areas en donde puede continuarse el 
%~ tr\'abajo. En cuanto al m\'odulo de visi\'on destacamos la investigaci\'on de 
%~ nuevas t\'ecnicas de descripci\'on de contornos para una mejor 
%~ caracterizaci\'on de los objetos y la utilizaci\'on de un clasificador 
%~ en reemplazo del mecanismo de filtros en cascada. SIGAN UDS O SACAMOS 
%~ FUTURE WORK.
