...
Principalmente de necesitabamos sensores de distancia con la apertura necesaria para cubrir lo
...
En contraparte los tel\'emetros infrarrojos no poseen esta limitaci\'on debido a que no tiene esta
limitaci\'on en cuanto a los rebotes.
Pero los rangos efectivos de detecci\'on de objetos no cubrian completamente nuestras necesidades.

Debido a las caracter\'isticas de los sensores decidimos combinarlos para aprovechar los beneficios de
cada uno de ellos y suplir las falencias de un tipo con otro el tipo.
...
un requerimiento de nuestro proyecto y el elevado costo sal\'a de nuestra escala.
...
Teniamos especificaciones que nos generaban la necesidad de ejercer control sobre los distitnos dispositivos
...
de desarrollo, costos y soporte a nivel repuestos, eligiimos una netbook como controlador principal del robot.
