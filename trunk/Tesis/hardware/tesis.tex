...
En la tabla \ref{hT_l298} mostramos la tabla de verdad para los pines de control, donde H es estado algo, L estado bajo y X cualquier estado.
...
Elegimos como controlador principal la netbook \emph{EeePC 1005-HA} de la marca Asus\footnote{www.asus.com}.
Como caracter\'isticas principales cuenta con un procesador Intel\footnote{www.intel.com} Atom N280 1.66 GHz, 1GB DDR-2, un disco de
...
En las tablas \ref{hT_comm_conexionLink} y \ref{hT_comm_conexionRS232} especificamos el conexionado entre las placas
...
En la tabla \ref{hT_comm_comandos_comunes} listamos y explicamos brevemente los comandos comunes del protocolo.
...
En las tablas \ref{hT_comm_comandos_motordc_a} y \ref{hT_comm_comandos_motordc_b} enumeramos los comandos para el
controlador \emph{DC MOTOR}.
El controlador \emph{SERVO MOTOR} responde a los comandos de las tablas \label{hT_comm_comandos_servo_a}
y \label{hT_comm_comandos_servo_b}
En la tabla \ref{hT_comm_comandos_distance} listamos los comandos del controlador \emph{DISTANCE SENSOR}.
De igual forma, aunque no esten implementados reservamos y especificamos los comandos para \emph{BATTERY CONTROLLER} y
\emph{TRASH BIN} en las tablas \ref{hT_comm_comandos_bateria} y \ref{hT_comm_comandos_basura} respectivamente.
...
de conocimiento y el punto de partida a futuro de un proyecto m\'as grande, decidimos producir nuestra propia versi\'on
...
En las tablas \ref{hT_comm_conexionLink} y \ref{hT_comm_conexionRS232} explicamos, respectivamente, el conexionado para cada caso.
...
\begin{figure}
	\centering
	\includegraphics[scale=.3]{gen_schemaMicro.png}
	\includegraphics[scale=.3]{gen_schemaHeaders.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=.3]{gen_schemaComm1.png}
	\includegraphics[scale=.3]{gen_schemaComm2.png}
	\includegraphics[scale=.3]{gen_schemaComm3.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=.3]{gen_schemaFuente.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=.2]{gen_top.png}
	\includegraphics[scale=.2]{gen_bottom.png}
...
Nuestro proyecto implicaba, entre otras cosas, el dise\~no y construcci\'on de un robot movil y como principal necesidad
ten\'ia que poder movilizarse por el terreno.
...
Como explicamos en la secci\'on \ref{h_actuadores_motorDC_circuito}.......................
