...
int main(int argc, char** argv)
{
    ...
    if( argc == 3 && (src=cvLoadImage(argv[1], 1))!= 0 && (test=cvLoadImage(argv[2], 1))!= 0){
		...
		CvHistogram * testImageHistogram = getHShistogram(test,hist_Hue_bins,1);
		...
		testHistogramImage=draw2dHistogram(testImageHistogram,hist_Hue_bins,1,10);
